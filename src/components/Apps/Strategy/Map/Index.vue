<template>
  <div width="100%">
    <v-toolbar dark flat>
      <v-toolbar-items>
        <v-select
          style="margin-left: 10px; margin-top: 8px; width: 200px"
          placeholder="Field"
          hide-details
        ></v-select>
                  ...
                  <v-card height="calc(100vh - 273px)">
                    ...
                    <v-card-text>
                      ...
                      <v-autocomplete
                        ...
                        multiple
                        :items="piechartItems"
                        v-model="selectedPiechartItems"
                        label="Pie Charts Items"
                      ></v-autocomplete>
                      <v-divider></v-divider>
                      ...
                      <v-autocomplete
                        ...
                        multiple
                        :items="heatmapItems"
                        v-model="selectedSizeMapField"
                        label="Size Map Items"
                      ></v-autocomplete>
                      <v-checkbox label="Use Retailer Map" hide-details v-model="useRetailerMap"></v-checkbox>
                      <v-autocomplete
                        v-if="useRetailerMap"
                        multiple
                        :items="selectedRetailers"
                        v-model="selectedRetailersFields"
                        label="Size Map Items"
                      ></v-autocomplete>
                    </v-card-text>
                    <v-card-actions>
...
export default {
  ...
  data() {
    return {
      ...
      config: null,
      tmpImageURL:
        "https://www.okcballet.org/wp-content/uploads/2016/09/placeholder-image.png",
      imgURL: "",
      imageLinkAddress: "",
      fileData: null,
      heatData: null,
      ...
      geoGridData: [],
      alpharray: [
        { text: "A", rangeStart: 0, rangeEnd: 10 },
        { text: "B", rangeStart: 10, rangeEnd: 20 },
        { text: "C", rangeStart: 20, rangeEnd: 30 },
        { text: "D", rangeStart: 30, rangeEnd: 40 },
        { text: "E", rangeStart: 40, rangeEnd: 50 },
        { text: "F", rangeStart: 50, rangeEnd: 60 },
        { text: "G", rangeStart: 60, rangeEnd: 70 },
        { text: "H", rangeStart: 70, rangeEnd: 80 },
        { text: "I", rangeStart: 80, rangeEnd: 90 },
        { text: "J", rangeStart: 90, rangeEnd: 100 },
        { text: "K", rangeStart: 100, rangeEnd: 110 }
      ]
    };
  },
  computed: {
