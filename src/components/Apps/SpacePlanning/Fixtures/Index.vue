    ...
    <v-container class="container-height " grid-list-md absolute dark fab top>
      <v-tabs class="elevation-4" centered dark fixed-tabs justify-content: center>
        ...
        <v-tab-item id="tab-1" justify-content: center>
          <v-card justify-content: center class="tab-item-wrapper back-height">
            <v-card-title>
              <v-spacer></v-spacer>
            ...
            <v-card-text>
              <v-flex xs12>
                <v-list dense class="elevation-5 pa-2">
                  <v-list-tile>
                    <v-list-tile-content>
        ...
        <v-tab-item id="tab-2" class="elevation-2" justify-content: center>
          <v-card justify-content: center class="tab-item-wrapper elevation-2 back-height">
            <v-card-title>
              <v-spacer></v-spacer>
              <v-text-field v-model="searchObstruction" append-icon="search" label="Search" single-line hide-details></v-text-field>
            </v-card-title>
            <v-card-text>
              <v-flex xs12>
...
<script>
  ...
  import FixturesModal from '@/components/Apps/SpacePlanning/Fixtures/Modal';
