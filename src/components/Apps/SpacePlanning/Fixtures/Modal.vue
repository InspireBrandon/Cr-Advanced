                ...
                <v-layout row wrap>
                  ...
                  <v-flex v-if="form.type == 0 && !form.rendering" lg8 md12 sm12 xs12>
                    <v-select
                      ...
                      :items="fixtureLabelOrders"
                      v-model="form.fixtureLabelOrder"
                      label="Label order:"
                    ></v-select>
                  </v-flex>
                  ...
                  <v-flex lg8 md12 sm12 xs12>
                    ...
                    <v-select
                      placeholder="please select"
                      v-if="form.type == 0  && form.rendering"
                      :items="renderingTypeGondola"
                      v-model="form.renderingType"
                      label="Rendering Type:"
                    ></v-select>
                    <v-select
                      placeholder="please select"
                      v-if="form.type == 2 && form.fixtureType == 1 || form.type == 3 && form.fixtureType == 4 && form.rendering"
                      :items="renderingTypeShelf"
                      v-model="form.renderingType"
                      label="Rendering Type:"
                    ></v-select>
                    ...
                    <v-select
                      placeholder="please select"
                      v-if="form.type == 3 && form.fixtureType == 3 && form.rendering"
                      :items="renderingTypeArea"
                      v-model="form.renderingType"
                      label="Rendering Type:"
                    ></v-select>
                    ...
                    <v-select
                      placeholder="please select"
                      v-if="form.type == 2 && form.fixtureType == 0 && form.rendering"
                      :items="renderingTypeBase"
                      v-model="form.renderingType"
                      label="Rendering Type:"
                    ></v-select>
                    <v-select
                      placeholder="please select"
                      v-if="form.type == 2 && form.fixtureType == 3 && form.rendering"
                      :items="renderingTypePegBar"
                      v-model="form.renderingType"
                      label="Rendering Type:"
                    ></v-select>
                    <v-select
                      placeholder="please select"
                      v-if="form.type == 3 && form.fixtureType == 1 && form.rendering"
                      :items="renderingTypeBasket"
                      v-model="form.renderingType"
                      label="Rendering Type:"
                    ></v-select>
                  </v-flex>
                  <v-flex lg8 md12 sm12 xs12 v-if="!form.rendering">
                    <v-select
                      placeholder="please select"
                      v-if="(form.fixtureType == 2 || form.fixtureType == 3) && form.type == 2"
                      :items="pegs"
                      v-model="form.defaultPeg"
                      label="Default peg:"
                    ></v-select>
                  </v-flex>
                  <v-flex lg8 md12 sm12 xs12 v-if="!form.rendering">
                    <v-select
                      placeholder="please select"
                      :items="SpreadProducts"
                      v-model="form.spreadProducts"
              ...
              <v-container grid-list-md>
                <v-layout row wrap>
                  ...
                  <v-flex lg8 md12 v-if="form.fixtureType == 2 && !form.rendering">
                    <v-text-field
                      type="number"
                      v-model="form.xHoleSpacing"
                      label="X hole spacing:"
                      suffix="cm"
                    ></v-text-field>
                  </v-flex>
                  <v-flex lg8 md12 v-if="form.fixtureType == 2 && !form.rendering">
                    <v-text-field
                      type="number"
                      v-model="form.yHoleSpacing"
                      label="Y hole spacing:"
                      suffix="cm"
                    ></v-text-field>
                  </v-flex>
                </v-layout>
                ...
                <v-layout row wrap>
                  <v-flex md4 class="px-3">
                    ...
                    <span>
                      ...
                      <span>
                        <a href="#" @click.prevent="frontBackMirror = !frontBackMirror" :style="{ 'background': frontBackMirror ? 'white': 'transparent' }">m</a>
                      </span>
                      <span class="ml-2">
                    ...
                    <img
                      ...
                      :src="getFixtureImageNew(frontBack == 'Front' ? form.frontImageID : form.backImageID)"
                      alt
                  ...
                  <v-flex md4 class="px-3">
                    <span>
                      <span style="padding-right: 75px;">{{ leftRight }}</span>
                      <span>
                        <a href="#" @click.prevent="leftRightMirror = !leftRightMirror" :style="{ 'background': leftRightMirror ? 'white': 'transparent' }">m</a>
                      </span>
                      <span class="ml-2">
                    ...
                    <img
                      ...
                      ref="sideImage"
                      style="width: 100%; max-height: 120px;"
                      :src="getFixtureImageNew(leftRight == 'Left' ? form.leftImageID : form.rightImageID)"
                      alt
                  ...
                  <v-flex md4 class="px-3">
                    ...
                    <span>
                      ...
                      <span>
                        <a href="#" @click.prevent="topBottomMirror = !topBottomMirror" :style="{ 'background': topBottomMirror ? 'white': 'transparent' }">m</a>
                      </span>
                      <span class="ml-2">
                    ...
                    <img
                      ...
                      ref="topImage"
                      style="width: 100%; max-height: 120px;"
                      :src="getFixtureImageNew(topBottom == 'Top' ? form.topImageID : form.bottomImageID)"
                      alt
                  ...
                  <v-flex md4 class="px-3">
                    <v-checkbox @change="transparentChange('Front')" v-if="frontBack == 'Front'" v-model="form.frontTransparent" label="Transparent"></v-checkbox>
                    <v-checkbox @change="transparentChange('Back')" v-if="frontBack == 'Back'" v-model="form.backTransparent" label="Transparent"></v-checkbox>
                  </v-flex>
                  <v-flex md4 class="px-3">
                    <v-checkbox @change="transparentChange('Left')" v-if="leftRight == 'Left'" v-model="form.leftTransparent" label="Transparent"></v-checkbox>
                    <v-checkbox @change="transparentChange('Right')" v-if="leftRight == 'Right'" v-model="form.rightTransparent" label="Transparent"></v-checkbox>
                  </v-flex>
                  <v-flex md4 class="px-3">
                    <v-checkbox @change="transparentChange('Top')" v-if="topBottom == 'Top'" v-model="form.topTransparent" label="Transparent"></v-checkbox>
                    <v-checkbox @change="transparentChange('Bottom')" v-if="topBottom == 'Bottom'" v-model="form.bottomTransparent" label="Transparent"></v-checkbox>
                  </v-flex>
                  ...
                  <v-flex v-if="!form.rendering &&renderingType0.length>1" lg8 md12 sm12 xs12 class="px-3">
                    <v-select
                      ...
                      v-model="selectedRenderingType0"
                      label="Label Holder:"
                    ></v-select>
                  </v-flex>
                  <v-flex v-if="!form.rendering &&renderingType1.length>1" lg8 md12 sm12 xs12 class="px-3">
                    <v-select
                      ...
                      v-model="selectedRenderingType1"
                      label="Shelf Edge:"
                    ></v-select>
                  </v-flex>
                  <v-flex v-if="!form.rendering &&renderingType2.length>1" lg8 md12 sm12 xs12 class="px-3">
                    <v-select
                      ...
                      v-model="selectedRenderingType2"
                      label="Back Face:"
                    ></v-select>
                  </v-flex>
                  <v-flex v-if="!form.rendering &&renderingType3.length>1" lg8 md12 sm12 xs12 class="px-3">
                    <v-select
                      ...
                      v-model="selectedRenderingType3"
                      label="Front Face:"
                    ></v-select>
                  </v-flex>
                  <v-flex v-if="!form.rendering &&renderingType4.length>1" lg8 md12 sm12 xs12 class="px-3">
                    <v-select
                      ...
                      v-model="selectedRenderingType4"
                      label="Side Face:"
                    ></v-select>
                  </v-flex>
                </v-layout>
