    ...
    <v-data-table hide-actions disable-initial-sort :headers="headers" :items="items">
        <template v-slot:items="props">
            <tr class="no-hover">
                ...
                <td>
                    <v-text-field v-model="props.item.pallet_Height" dense full-width flat solo hide-details class="mt-0">
                    </v-text-field>
                </td>
                <td>
                    <v-text-field v-model="props.item.pallet_Width" dense full-width flat solo hide-details class="mt-0">
                    </v-text-field>
                </td>
                <td>
                    <v-text-field v-model="props.item.pallet_Depth" dense full-width flat solo hide-details class="mt-0">
                    </v-text-field>
                </td>
                <td>
