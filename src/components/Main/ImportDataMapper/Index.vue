    ...
    <div>
        <v-card tile flat>
            <v-toolbar dark dense flat>
                ...
                <v-spacer></v-spacer>
                <v-toolbar-title>Import data map</v-toolbar-title>
            </v-toolbar>
                ...
                <v-layout row wrap>
                    <v-flex xs7 md8 class="pa-2">
                        <v-layout row wrap>
                            ...
                            <v-flex xs4>
                                <v-text-field class="pt-0" hide-details prepend-inner-icon="search"
                    ...
                    <v-flex xs5 md4>
                        <v-card tile flat style="border-left: 1px solid #e2e2e2; height: calc(100vh - 112px);">
                            <v-card-text>
                                ...
                                <v-text-field class="mb-2" hide-details prepend-inner-icon="search"
                                    placeholder="Search...">
                                </v-text-field>
                                ...
                                <v-card flat style="height: calc(100vh - 248px); overflow-y: auto;">
                                    <v-card @click="checkDrill(item)" :draggable="retailer != null"
                                        style="cursor: pointer;"
                                        @dragstart="dragStart(item)" @dragend="clearDrag"
                                        v-for="(item, idx) in systemValues" :key="idx" class="mb-1"
