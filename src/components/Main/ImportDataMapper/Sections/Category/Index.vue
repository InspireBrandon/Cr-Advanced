                    ...
                    return self.rowData.filter(e => {
                        if (e.systemCategory_Name == null) {
                            ...
                            return (e.name.toUpperCase().indexOf(self.searchTextGrid.toUpperCase()) > -1 || e
                                .systemCategory_Name.toUpperCase().indexOf(self.searchTextGrid
                                    .toUpperCase()) > -1);
                        }
                    })
                }
        ...
        methods: {
            ...
            getImportCategories() {
                ...
                Axios.get(process.env.VUE_APP_API +
                        `SuplierLocationImportTX/Categories?userID=${encoded_details.USER_ID}`)
                    .then(r => {
                        console.log(r.data)
                        self.rowData = r.data;
                    })
            ...
            getSystemCategories() {
                ...
                Axios.get(process.env.VUE_APP_API + `SystemCategory`)
                    .then(r => {
