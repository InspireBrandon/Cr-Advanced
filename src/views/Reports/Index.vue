        ...
        <v-navigation-drawer floating fixed app>
            <v-layout column fill-height>
                ...
                <v-expansion-panel class="elevation-0">
                    <v-expansion-panel-content class="elevation-0">
                        ...
                        <v-list>
                            ...
                            <v-list-tile v-for="(item, idx) in systemReports" :key="idx" @click="$router.push(item.route)">
                                <v-list-tile-action>
                ...
                <v-expansion-panel class="elevation-0">
                    <v-expansion-panel-content class="elevation-0">
                        <template v-slot:header>
                            <div>Application Reports</div>
                        </template>
                        <hr>
                        <v-list>
                            <v-list-tile v-for="(item, idx) in applicationReports" :key="idx">
